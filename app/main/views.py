...
from .forms import ProfileUpdate,Blog
from .. import db
...
def save_picture(form_picture):
    ...
    picture_path = os.apth.join('app/static/photos',picture_filename)
...
def profile():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Profile successfull updated')
...
def new_blog():
    ...
    if form.validate_on_submit():
        ...
        blog = Blog(title = title,content = content,id = user_id)
        blog.save()
        for subscriber in subscribers:
            mail_message("Blog new post","email/new_blog",subscriber.email,blog = blog)
...
def subscribe():
    ...
    mail_message("Subscribed to Blog-Web","email/welcome_subscriber",new_subscriber.email,new_subscriber=new_subscriber)
